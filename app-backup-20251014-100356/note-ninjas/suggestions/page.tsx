  ...
  return (
    <main className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mb-6">
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-gray-700 text-base leading-relaxed">
              ...
              resistance band exercises, then progresses to functional overhead
              activities. Since progress has stalled, consider modifying
              exercise parameters (frequency, resistance, range) or introducing
              manual therapy to address underlying restrictions before advancing
        ...
        {recommendations && recommendations.suggested_alternatives && recommendations.suggested_alternatives.length > 0 && (
          <div className="mb-8">
