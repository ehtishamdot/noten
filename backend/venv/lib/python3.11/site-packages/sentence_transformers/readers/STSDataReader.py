...
class STSDataReader:
    ...
    Default values expects a tab separated file with the first & second column the sentence pair and third column the score (01). Default config normalizes scores from 05 to 01
    """
    ...
    def get_examples(self, filename, max_examples=0):
        ...
        with (
            ...
            for id, row in enumerate(data):
                ...
                if self.normalize_scores:  # Normalize to a 01 value
...
class STSBenchmarkDataReader(STSDataReader):
    ...
    Scores are normalized from 05 to 01
    """
