...
class WorkerState(str, Enum):
    ...
    in a worker group fails the entire set is considered failed::
      ...
      FAILED - workers failed to  finish (exit !0)
...
class RunResult:
    ...
    only if ALL local workers managed by this agent complete .
...
class SimpleElasticAgent(ElasticAgent):
    ...
    def _exit_barrier(self):
        ...
        executing their local workers (either  or not). This
