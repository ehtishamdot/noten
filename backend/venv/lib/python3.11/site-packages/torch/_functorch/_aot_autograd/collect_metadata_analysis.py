    ...
    def inner(*flat_args):
        ...
        for o in flat_f_outs:
            if isinstance(o, torch.Tensor):
                ...
                #
                # For a set of outputs of the graph that alias each other, o_1o_k, consider:
                ...
                # (3) o_1o_k all require_grad, they all share the same ._base, and their ._base requires grad.
                #     This condition is important because it's what causes slowness in the intermediate_base
                #     codepath of aot_autograd. Ordinarily, o_1o_k would all get a grad_fn, and
                ...
                #     Autograd raises the same error
                # (e) What if we try to mutate another alias of o_1o_k, that was **not** created from a multi-output view?
                #     We promised that there is at most **one** such alias, e.g. intermediate in the example above.
                #     You can mutate intermediate, but in eager mode this will change the grad_fn of o_1o_k
                #     to be error fn's.
